...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12"
    ...
    <div x-show="completed" x-data="{ tab: 'technologie' }">
        ...
        <div class="bg-white/2 border border-white/8 rounded-2xl overflow-hidden mb-8">
            <div class="px-6 py-4 border-b border-white/5 flex items-center justify-between">
                ...
                <a href="{{ route('scan.pdf', $scan) }}"
                   class="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold px-4 py-2 rounded-xl transition shadow-md shadow-indigo-500/20">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                    Download PDF
                </a>
                @else
                <span class="inline-flex items-center gap-2 text-gray-500 text-sm bg-white/3 border border-white/8 px-4 py-2 rounded-xl cursor-not-allowed">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                    PDF <span class="text-purple-400 text-xs font-bold">PRO</span>
                </span>
                @endif
            </div>
            <div class="px-6 py-5">
        ...
        {{-- Website Health Check (non-technical overview) --}}
        @php
            $r = $scan->results;
            $healthChecks = [
                [
        ...
        <div class="mt-12 flex flex-col sm:flex-row items-center justify-center gap-3 flex-wrap">
            ...
            <a href="{{ route('scan.compare', ['a' => $scan->host]) }}" class="inline-flex items-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 text-white font-semibold px-6 py-3 rounded-xl transition">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                </svg>
                Compare with competitor
            </a>
            <a href="{{ route('scan.recent') }}" class="inline-flex items-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 text-white font-semibold px-6 py-3 rounded-xl transition">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
                Browse recent scans
