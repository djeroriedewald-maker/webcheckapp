...
@section('title', __('auth_signin') . ' — WebCheckApp')
@section('meta_description', __('auth_signin_desc'))
...
<div class="max-w-md mx-auto px-4 py-16">
    ...
    <div class="text-center mb-10">
        <h1 class="text-3xl font-bold mb-2">{{ __('auth_signin') }}</h1>
        <p class="text-gray-400">{{ __('auth_signin_desc') }}</p>
    </div>
    ...
    <div class="bg-white/3 border border-white/8 rounded-2xl p-8">
        ...
        <p class="text-center text-sm text-gray-500 mt-6">
            {{ __('auth_no_account') }}
            <a href="{{ route('register') }}" class="text-indigo-400 hover:text-indigo-300">{{ __('auth_create_free') }}</a>
        </p>
