...
<section class="relative overflow-hidden min-h-[600px] flex items-center">
    ...
    <div class="relative w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28 text-center">
        <div class="">
            ...
            <form action="{{ route('scan.store') }}" method="POST" x-data="{ loading: false }" @submit.prevent="loading = true; $dispatch('scan-start', { url: $el.querySelector('[name=url]').value, form: $el })">
                @csrf
